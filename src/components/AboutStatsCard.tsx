...
//             className="flex-1 relative z-10 bg-gradient-to-r from-[#230a27]/70 to-[#053c54]/30 backdrop-blur-lg border border-white/10 rounded-2xl p-6 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl h-full flex flex-col justify-between">
...
export default function AboutStatsCard({
    ...
    return (
        ...
        >
            <div className="relative z-10 hover-star-border bg-gradient-to-r from-[#230a27]/70 to-[#053c54]/30 backdrop-blur-lg rounded-2xl p-6 border border-white/10 overflow-hidden transition-all duration-300  hover:shadow-2xl h-full flex flex-col justify-between">
                {/* Inre bakgrundsgradient */}
